    ...
    try:
        ...
        response = emr_client.add_job_flow_steps(
            ...
            Steps=[{
                ...
                'HadoopJarStep': {
                    'Jar': 'command-runner.jar',
                    'Args': ['spark-submit', '--deploy-mode', 'cluster', '--master', 'yarn',"--conf","spark.yarn.submit.waitAppCompletion=true",'--executor-memory', executor_memory, '--executor-cores' , executor_cores,
